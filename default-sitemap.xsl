...
>
	...
	<a href="https://salinas-armendariz.com/"><span>Hogar</span></a>
	...
	<a href="https://salinas-armendariz.com/"><span>Hogar</span></a>
			...
			<svg width="6" height="8" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M.727 7.06L3.78 4 .727.94l.94-.94 4 4-4 4-.94-.94z" fill="#141B38"/></svg>
					...
					<a href="https://salinas-armendariz.com/sitemap.xml"><span>Índice del mapa del sitio</span></a>
						<svg width="6" height="8" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M.727 7.06L3.78 4 .727.94l.94-.94 4 4-4 4-.94-.94z" fill="#141B38"/></svg>
	...
	<div id="content-head">
		...
		<xsl:if test="$amountOfURLs &gt; 0">
			<p>
				...
				y se generó el 11/06/2024 a las 12:40 pm			</p>
		</xsl:if>
	</div>
</xsl:template>
	...
	<a href="https://salinas-armendariz.com/"><span>Hogar</span></a>
		...
		<div class="empty-sitemap__buttons">
			<a href="https://salinas-armendariz.com/" class="button">Volver a la página de inicio</a>
					</div>
